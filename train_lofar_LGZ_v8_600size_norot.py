...
"""
dataset_dicts = get_lofar_dicts(os.path.join(base_path,"VIA_json_train.pkl"))
...
cfg.merge_from_file("/data/mostertrij/tridentnet/detectron2/configs/COCO-Detection/v8_faster_rcnn_X_101_32x8d_FPN_3x.yaml")
