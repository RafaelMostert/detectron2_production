...
../configs/lofar_detection/LB300_precomputed_removed_withRot_constantLR_network.yaml \
/data1/mostertrij 1 &> logs/LB300_precomputed_removed_withRot_constantLR_1_network.txt &
sleep 60
CUDA_VISIBLE_DEVICES=1 python ../train_lofar.py \
../configs/lofar_detection/LB300_precomputed_removed_withRot_constantLR_network.yaml \
/data1/mostertrij 2 &> logs/LB300_precomputed_removed_withRot_constantLR_2_network.txt &
sleep 90
CUDA_VISIBLE_DEVICES=2 python ../train_lofar.py \
../configs/lofar_detection/LB300_precomputed_removed_withRot_constantLR_network.yaml \
/data1/mostertrij 3 &> logs/LB300_precomputed_removed_withRot_constantLR_3_network.txt &
