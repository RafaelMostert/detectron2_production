...
/data1/mostertrij \
/data/mostertrij/tridentnet/output/uLB300_fast_R50_removed_withRot_constantLR_initializeWeights_seed1/model_0064999.pth \
1 &> logs/eva65k_LB300_Spring_using_uLB300_fast_R50_removed_withRot_constantLR_initializeWeights_seed1.txt
