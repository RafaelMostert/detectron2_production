...
../configs/lofar_detection/LB300_precomputed_removed_withRot_constantLR.yaml \
/data1/mostertrij 4 &> logs/LB300_precomputed_removed_withRot_constantLR_4.txt &
#CUDA_VISIBLE_DEVICES=3 python ../evaluate_lofar.py \
#../configs/lofar_detection/LB300_precomputed_removed_withRot_constantLR.yaml \
#/data1/mostertrij \
#/data/mostertrij/tridentnet/output/LB300_precomputed_removed_withRot_constantLR/model_0043999.pth \
#&> logs/eva_precomputed_removed_withRot_constantLR_1.txt &
