...
/data1/mostertrij \
/data/mostertrij/tridentnet/output/uLB300_fast_R50_removed_withRot_constantLR_seed3/model_0019999.pth \
3 &> logs/eva20k_LB300_Spring_using_uLB300_fast_R50_removed_withRot_constantLR_seed3.txt
