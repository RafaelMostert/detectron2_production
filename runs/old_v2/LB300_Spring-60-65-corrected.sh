...
../configs/lofar_detection/LB300_Spring_60_65_corrected.yaml \
/data1/mostertrij \
/data/mostertrij/tridentnet/output/uLB300_precomputed_removed_withRot_constantLR_testIOU_seed2/model_0019999.pth \
2 &> logs/eva20k_LB300_Spring_using_uLB300_precomputed_removed_withRot_constantLR_testIOU_seed2.txt
